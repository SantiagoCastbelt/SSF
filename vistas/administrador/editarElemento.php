  ...
  <div class="d-flex" id="content-wrapper">
    ...
    <div class="w-100">
      ...
      <div class="container">
        ...
        <h2>Editar informacion de elementos</h2>
        ...
        $NombreServicio = $_GET['nombre'];
        $Codelemento = $_GET['Codelemento'];
        $Nombre = $_GET['Nombre'];
        $costo = $_GET['costo'];
        ...
        <form action="../../controladores/ControladoresAdmin/controladorElementos.php" method="POST">
          <div class="row-fluid">
            ...
            <div class="col-md-2">
              <label for="Codelemento" class="text-left">Numero Elemento</label>
              <input type="text" name="Codelemento[]" class="form-control" value="<?= $Codelemento ?>" required>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-2">
              ...
              <input type="text" name="costo[]" class="form-control" value="<?= $costo ?>" required>
            </div>
            <div class="col-md-1">
