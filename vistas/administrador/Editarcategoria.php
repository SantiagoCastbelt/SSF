    ...
    <div class="d-flex" id="content-wrapper">
        ...
        <div id="content" class="bg-grey w-100">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-9 col-md-8">
                        <p class="font-weight-bold mb-0">Apartado para editar informacion sobre la categoria asignada.</p>
                    </div>
                </div>
                ...
                <form class="row" action="../../controladores/formcontroller.php" method="POST">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="codigo" class="form-control" value="<?= $id ?>">
                    </div>
                    <div class="col-md-4">
            ...
            <div class="col-md-12">
                <br>
                <input type="submit" name="guardar" value="Editar categoria" class="btn btn-primary form-control">
